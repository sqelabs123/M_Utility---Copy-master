...
public class ExtentReportClass extends BrowserList{
	...
	public void setExtent() throws InterruptedException, IOException{
		...
		extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/ExtentReportResult.html");
		extent.addSystemInfo("Version", " UI.6.0.160/DB UI.6.0.160/Engine 2.1.0049");
	}
